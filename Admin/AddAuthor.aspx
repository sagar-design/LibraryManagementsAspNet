...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12 px-lg-4">
        <div class="form-group mb-4 d-flex justify-content-end">
            ...
            <asp:Button ID="btnupdate" CssClass="btn btn-info ms-2" runat="server" Text="Update" Height="40px" Width="120px" Visible="false" OnClick="btnupdate_Click" />
            <asp:Button ID="btncancel" CssClass="btn btn-danger ms-2" runat="server" Text="Cancel" Height="40px" Width="120px" Visible="false" OnClick="btncancel_Click"/>
        </div>
    </div>
</div>
