        ...
        <div>
            <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
                <a class="navbar-brand" href="Default.aspx">
                    <img src="LogoImg/logoIcon.ico" width="49" height="49" alt="Library Logo" />
                    Library Application
                </a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"><b>Archives</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link"><b>Publications</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link"><b>Gallery</b></a>
                        </li>
                        <li class="nav-item">
...
<%--                        <a class="btn btn-sm btn-primary" href="SignUp.aspx">Sign Up</a>--%>
                            <a href="SignUp.aspx" class="btn btn-secondary">Sign Up</a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col">
                                                                <center>
                                                                    <img width="150" src="LogoImg/user.png" alt="User Icon" />
                                                                </center>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col">
                                                                <center>
                                                                    <img width="150" src="LogoImg/admin.png" alt="Admin Icon" />
                                                                </center>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="form-group">
                                                                    <asp:TextBox ID="txtAdminID" CssClass="form-control" placeholder="admin" runat="server"></asp:TextBox>
                                                                </div>
                                                                <label for="txtAdminPass">Password</label>
                                                                <div class="form-group">
                                                                    <asp:TextBox ID="txtAdminPass" CssClass="form-control" placeholder="admin" TextMode="Password" runat="server"></asp:TextBox>
                                                                </div>
                                                                <div class="form-group">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 fa-copyright border-dark">
                            <p class="text-center">&copy; Copyright 2024 - Sagar Ss. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
